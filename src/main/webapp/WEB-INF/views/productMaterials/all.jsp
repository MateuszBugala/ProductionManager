...
<table border="1" style="text-align: center">
    ...
    <c:forEach items="${productMaterials}" var="productMaterial" varStatus="stat">
        <tr>
            ...
            <td style="width: 50px"><a href="/productMaterials/delete/${productMaterial.id}" onclick="return confirm('Are you sure you want to delete this item?');" >Delete</a></td>
        </tr>
    </c:forEach>
    </tbody>
...
<c:if test ="${not empty param.error}">
    <h4 style="color: red"><span>Product material cannot be deleted - it has some records in database</span></h4>
</c:if>
