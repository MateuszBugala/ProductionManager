    ...
    <c:otherwise>
        ...
        <div class="w3-display-container w3-animate-opacity">
            ...
            <div class="w3-container w3-display-middle w3-margin-bottom">
                <p>
                    <button onclick="location.href='/login/'" class="w3-button w3-xxxlarge w3-theme w3-hover-teal">Log
                        in
                    </button>
                </p>
                <p>
                    <button onclick="location.href='/users/add'" class="w3-button w3-xxxlarge w3-theme w3-hover-teal">
                        Create an account
                    </button>
                </p>
            ...
            <div class="w3-quarter">
                <div class="w3-card w3-white">
                    ...
                    <div class="w3-container">
                        ...
                        <p>- once you approve the prices and conditions your quotation is stored in database for further
                            reference</p>
                        <p></p>
